...
scenarios_panel = read_excel(paste(
  output_path, 
  "h1b_scenarios_panel_inc_payroll_excise_tax.xlsx",
  sep="/")) %>%
...
# export dataset
write.xlsx(scenarios_panel, paste(output_path, "h1b_scenarios_panel_inc_payroll_excise_customs_tax.xlsx",sep="/"))
